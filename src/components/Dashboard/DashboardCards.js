          ...
          <Paper className={classes.paper}>
            ...
            <span class="material-icons">euro</span>
              <div className="card-content">
                <div className="card-text">Total value (all contracts)</div>
                <div className="card-value">€888,888.88</div>
              </div>
            </div>
          </Paper>
        </Grid>
        <Grid item lg={3} xs={12}>
          <Paper className={classes.paper}>
            <div className="dashboard-card">
              ...
              <div className="card-content">
                <div className="card-text">contracts about to expire</div>
        ...
        <Grid item lg={3} xs={12}>
          <Paper className={classes.paper}>
            <div className="dashboard-card">
              ...
              <div className="card-content">
                <div className="card-text">proposals generated (ytd)</div>
                <div className="card-value">
                  <span>888</span>
                  <div className="card-trending">
                    <span class="material-icons">trending_up</span>
                    <span className="trending-up-value">+ 214</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="dashboard-card">
              ...
              <div className="card-content">
                ...
                <div className="card-value">
                  ...
                  <div className="card-trending">
                    <span class="material-icons">trending_up</span>
                    <span className="trending-up-value">+ 7</span>
                  </div>
                </div>
              </div>
            </div>
